...
- [x] 3.2 在自选股页面添加测试基金（如 510050）
- [x] 3.3 验证基金价格显示3位小数
- [x] 3.4 验证股票价格仍显示2位小数
- [x] 3.5 验证基金的涨跌额和涨跌幅也显示3位小数
- [x] 3.6 验证股票的涨跌额和涨跌幅仍显示2位小数
- [x] 3.7 测试边界情况：价格为 null、0、负数时的显示
...
- [x] 5.1 在工具函数中添加使用说明注释
- [x] 5.2 创建 git 分支（如 `feature/price-display-precision`）
- [x] 5.3 提交代码变更
- [x] 5.4 推送分支到远程仓库
